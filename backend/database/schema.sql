...
-- Versión: 1.1
-- Fecha: 2026-04-12
-- Total de tablas: 6 (eliminadas game_progress y user_mutes)
-- ========================================
...
-- ========================================
-- TABLA 5: MESSAGES
-- Chat global y mensajes privados entre usuarios
-- session_id = NULL y receiver_id = NULL → mensaje global
...
-- game_progress y user_mutes eliminadas (no usadas)
